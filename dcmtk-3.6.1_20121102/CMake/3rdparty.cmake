  ...
  # offical sites.
    ...
    IF(DCMTK_WITH_XML)
      IF(WITH_LIBXMLINC)
        ...
        SET(LIBXML_INCDIR ${CMAKE_BINARY_DIR}/${3RDLIB_FOLDER_NAME}/${XML2_LIBRARY}/${XML2_LIBRARY} ${XML2_ORIGN_DIR}/include ${CMAKE_BINARY_DIR}/${3RDLIB_FOLDER_NAME}/${ICONV_LIBRARY}/${ICONV_LIBRARY})
        SET(WITH_LIBXML 1)
    ...
    IF(DCMTK_WITH_TIFF)
      IF(WITH_LIBTIFFINC)
        ...
        SET(LIBTIFF_INCDIR ${CMAKE_BINARY_DIR}/${3RDLIB_FOLDER_NAME}/${TIFF_LIBRARY}/${TIFF_LIBRARY} ${TIFF_ORIGN_DIR})
        SET(WITH_TIFF 1)
    ...
    IF(DCMTK_WITH_PNG)
      IF(WITH_LIBPNGINC)
        ...
        SET(LIBPNG_INCDIR ${CMAKE_BINARY_DIR}/${3RDLIB_FOLDER_NAME}/${PNG_LIBRARY}/${PNG_LIBRARY} ${PNG_ORIGN_DIR})
        SET(WITH_PNG 1)
    ...
    IF(DCMTK_WITH_ZLIB)
      IF(WITH_ZLIBINC)
        ...
        SET(ZLIB_INCDIR ${CMAKE_BINARY_DIR}/${3RDLIB_FOLDER_NAME}/${ZLIB_LIBRARY}/${ZLIB_LIBRARY} ${ZLIB_ORIGN_DIR})
        SET(WITH_ZLIB 1)
    ...
    IF(DCMTK_WITH_OPENSSL)
      IF(WITH_OPENSSLINC)
        ...
        SET(OPENSSL_INCDIR ${CMAKE_BINARY_DIR}/${3RDLIB_FOLDER_NAME}/${OPENSSL_LIBRARY}/${OPENSSL_LIBRARY}/inc32/)
    ...
    IF(DCMTK_WITH_ICONV)
      IF(WITH_LIBICONVINC)
        ...
        SET(LIBICONV_INCDIR ${ICONV_ORIGN_DIR} ${ICONV_ORIGN_DIR}/include ${CMAKE_BINARY_DIR}/${3RDLIB_FOLDER_NAME}/${ICONV_LIBRARY}/${ICONV_LIBRARY})
        SET(WITH_LIBICONV 1)
